...
public class ResourceSets {
    ...
    public static void createResourceSets() {
        ...
        new ResourceSetBuilder("copper", "Copper", 0xe77c56)
                .addIngredients(MaterialCraftingIngredientsMetal.PLATE, MaterialCraftingIngredientsMetal.ROD, MaterialCraftingIngredientsMetal.GEAR, MaterialCraftingIngredientsMetal.WIRE, MaterialCraftingIngredientsMetal.SHEET, MaterialCraftingIngredientsMetal.DUST, MaterialCraftingIngredientsMetal.CRUSHED, MaterialCraftingIngredientsMetal.BOLT, MaterialCraftingIngredientsMetal.SCREW, MaterialCraftingIngredientsMetal.SPRING, MaterialCraftingIngredientsMetal.SPRING, MaterialCraftingIngredientsMetal.ROTOR)
                .build();

        new ResourceSetBuilder("iron", "iron", 0xD8D8D8)
                .addIngredients(MaterialCraftingIngredientsMetal.PLATE, MaterialCraftingIngredientsMetal.ROD, MaterialCraftingIngredientsMetal.GEAR, MaterialCraftingIngredientsMetal.WIRE, MaterialCraftingIngredientsMetal.SHEET, MaterialCraftingIngredientsMetal.DUST, MaterialCraftingIngredientsMetal.CRUSHED, MaterialCraftingIngredientsMetal.BOLT, MaterialCraftingIngredientsMetal.SCREW, MaterialCraftingIngredientsMetal.SPRING, MaterialCraftingIngredientsMetal.ROTOR)
                .build();
        ...
        new ResourceSetBuilder("lapis", "Lapis", 0x1e3c8b)
                .addIngredients(MaterialCraftingIngredientsMetal.DUST, MaterialCraftingIngredientsMetal.CRUSHED, MaterialCraftingIngredientsMetal.SHEET, MaterialCraftingIngredientsMetal.ROD)
                .build();

        new ResourceSetBuilder("emerald", "Emerald", 0x00aa2c)
                .addIngredients(MaterialCraftingIngredientsMetal.PLATE, MaterialCraftingIngredientsMetal.ROD, MaterialCraftingIngredientsMetal.GEAR, MaterialCraftingIngredientsMetal.DUST, MaterialCraftingIngredientsMetal.CRUSHED, MaterialCraftingIngredientsMetal.BOLT, MaterialCraftingIngredientsMetal.SCREW, MaterialCraftingIngredientsMetal.ROTOR)
                .build();
        ...
        new ResourceSetBuilder("terranium", "Terranium", 0x7eff33)
                ...
                .removeNetherOres()
                .removeFlexible()
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.INGOT, "item/base_ingot_alt_one")
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.BLOCK, "block/base_metal_block_alt_three")
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.NUGGET, "item/base_nugget_alt_one")
        ...
        new ResourceSetBuilder("osmium", "Osmium", 0xb0fff6)
                ...
                .removeNetherOres()
                .removeFlexible()
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.BLOCK, "block/base_metal_block_alt_five")
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.NUGGET, "item/base_nugget_alt_one")
        ...
        new ResourceSetBuilder("nickel", "Nickel", 0xc4c7b7)
                .addAllIngredients(true)
                .removeNetherOres()
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.BLOCK, "block/base_metal_block_alt_two")
                .build();
        ...
        new ResourceSetBuilder("uranium", "Uranium", 0x177d00)
                ...
                .removeFlexible()
                .removeConductive()
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.INGOT, "item/base_ingot_alt_two")
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.BLOCK, "block/base_metal_block_alt_four")
                .build();
        ...
        new ResourceSetBuilder("rutherfordium", "Rutherfordium", 0x3e3240)
                ...
                .removeFlexible()
                .isGem()
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.GEM, "item/base_gem_alt_one")
                .changeOreOverlay("block/base_ore_overlay_alt_three")
                .build();
        ...
        new ResourceSetBuilder("iridium", "Iridium", 0xfffacf)
                ...
                .removeNetherOres()
                .isGem()
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.GEM, "item/base_gem_alt_two")
                .build();
        ...
        new ResourceSetBuilder("steel", "Steel", 0x696969)
                ...
                .removeFlexible()
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.INGOT, "item/base_ingot_alt_one")
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.BLOCK, "block/base_metal_block_alt_one")
                .build();
        ...
        new ResourceSetBuilder("rose_gold", "Rose Gold", 0xe8acac)
                ...
                .removeConductive()
                .isGem()
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.GEM, "item/base_gem_alt_three")
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.BLOCK, "block/base_metal_block_alt_four")
                .build();
        ...
        new ResourceSetBuilder("azbantium_enderium_alloy", "Azbantium-Enderium Alloy", 0x138542)
                .addAllIngredients(false)
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.INGOT, "item/base_ingot_alt_three")
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.NUGGET, "item/base_nugget_alt_one")
                .setAlternativeTexture(MaterialCraftingIngredientsMetal.BLOCK, "block/base_metal_block_alt_five")
                .build();
